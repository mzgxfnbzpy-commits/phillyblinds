...
function crsSubmit() {
  ...
  .catch(function() {
    ...
    window.location.href = 'mailto:justin@phillyblinds.com,sarah@phillyblinds.com,mike@phillyblinds.com,tarin@phillyblinds.com?subject=' + encodeURIComponent('Basic Roller Quote — ' + name) + '&body=' + encodeURIComponent(lines.join('\n'));
  });
}
